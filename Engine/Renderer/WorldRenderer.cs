...
namespace CorrinoEngine.Renderer
{
    public class WorldRenderer
    {
        ...
        public void Render(Camera camera, IEnumerable<Actor> actors = null, Actor selectedActor = null, Actor pendingPlacementActor = null, Vector3 pendingPlacementPosition = default, Vector2i pendingPlacementFootprint = default, float placementTileSize = 48f, bool isPendingPlacementValid = false)
        {
            ...
            {
                DrawSelectionRing(camera, selectedActor.Position, selectedActor.SelectionRadius, new Vector3(0.92f, 0.81f, 0.36f));
            }
